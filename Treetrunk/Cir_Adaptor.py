...
#######################################################################
def generate_config(input,txtfile,cavity_radius,geometry):
        config = '''
...
class Cir_Adaptor():
    ...
    def run_Ascan(self):
        ...
        api(self.input, n=1, geometry_only=False)
    ...
    def run(self):
        ...
        generate_config(self.input,self.filename,self.cavity,f'treetrunk_{round(self.distance,2):.2f}_{self.cavity:.2f}')
