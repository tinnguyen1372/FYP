...
for i in range(1,21):
    if i % 2 == 1:
        image1 = cv2.imread('{}/output_image_{}.png'.format(directory, i))
        image2 = cv2.imread('{}/healthy{}.png'.format(result, int((i - 1) / 2 +1)))
    else:
        image1 = cv2.imread('{}/output_image_{}.png'.format(directory, i))
        image2 = cv2.imread('{}/defect{}.png'.format(result, int(i / 2) - 1 +1))
